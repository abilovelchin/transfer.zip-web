...
const features = [
  {
    ...
    description:
      "No transfer.javascript.az account is needed for others - simply provide them with an upload link. It is the easiest way to receive files on the web.",
    icon: "arrow-down",
  ...
  },
  {
    ...
    description:
      "You can disable or re-enable your personal links at any time. Create as many links as you desire.",
    icon: "toggle-on",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-600">
            Generate dedicated links for others to upload files directly to you.
            You can embed these upload links on your website, distribute them,
            or email them.
          </p>
        </div>
