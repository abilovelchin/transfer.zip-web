  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-xl text-center">
        <h2 className="text-base/7 font-semibold text-primary" id="pricing">
          Pricing
        </h2>
      ...
      <p className="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg font-medium text-gray-600 sm:text-xl/8">
        We employ a pricing strategy that values transparency and fairness,
        allowing you to focus on your work, without worrying about hidden fees.
      </p>
            ...
            <div>
              ...
              <p className={`text-gray-600 mt-6 text-base/7 max-w-md`}>
                <span className="hidden md:inline">
                  {" "}
                  Send files without size limits, with end-to-end encryption.
                </span>{" "}
                transfer.javascript.az can be used without an account, but
                without storing files for very long.
              </p>
            </div>
            <div>
              <ul
                  ...
                  <li key={feature.name} className="flex gap-x-3">
                    <BIcon
                      ...
                      className={`h-5 w-5 flex-none ${
                        feature.good ? "text-primary" : "text-red-600"
                      }`}
                    />
                    {feature.name}
                  </li>
