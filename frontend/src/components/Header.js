...
const products = [
  {
    name: "Limitless File Sharing",
    description: "Send Your Files in Seconds",
    href: "/#about",
    icon: "lightbulb",
  },
  {
    name: "Receive Files with a Link",
    description: "Easily Receive Files from Anyone",
    href: "/#features-receive",
    icon: "arrow-down",
  },
  {
    name: "365 Days Expiration Time",
    description: "Big Files That Don't Expire",
    href: "/#features",
    icon: "clock",
  },
  {
    name: "Quick Share",
    description: "Keep Your Tab Open - Send Without Limits",
    href: "/#about-quick-share",
    icon: "lightning-fill",
  },
];
const callsToAction = [
...
export default function Header() {
  ...
  const ctaText = useMemo(
    () => (isGuestUser ? "Sign Up!" : "Dashboard"),
    [isGuestUser]
  );
  const ctaLink = useMemo(
    () => (isGuestUser ? "/signup" : "/app"),
    [isGuestUser]
  );
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          {isGuestUser ? (
            <Link
              ...
              to={ctaLink}
              className="text-sm/6 font-semibold text-white rounded-full bg-primary px-3 py-0.5 hover:bg-primary-light"
            >
