...
export default function ZipFilesPage({}) {
  ...
  const doZip = async () => {
    ...
    for (let file of files) {
      let zipWriter = zipStream
        .writable(file.webkitRelativePath || file.name)
        .getWriter();
  ...
  return (
    <div>
      <GenericToolPage
        ...
        display={
          <span>
            <span className="text-primary">Easily</span> create zip files
            online.
          </span>
        }
        subtitle={
          "Effortlessly compress even the biggest files with this online file and folder zip tool. You can also choose to share the zip file for free afterwards, if you need to."
        }
      >
        <div className="mx-auto max-w-sm">
          <FileUpload
            onFiles={handleFiles}
            buttonText={"Zip"}
            showProgress={!!maxBytes}
            progressElement={<Progress max={maxBytes} now={progressBytes} />}
          />
        </div>
      </GenericToolPage>
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-16">
        {!isSelfHosted() && (
          <>
            <div className="mt-16">
              <h2 className="inline-block text-2xl mb-4 font-bold">
                How does it work?
              </h2>
              <p className="text-lg mb-2">
                Simply pick files and folder from your computer, and they will
                be compressed instantly into one zip file.
              </p>
              <p className="text-lg mb-2">
                You can then choose to download or share the newly created zip
                file for free if needed.
              </p>
              <p className="text-lg mb-2">
                <b>Your files never leave your computer</b> - everything is
              ...
              <p className="text-lg mb-2">
                ...
                <a
                  ...
                  href="https://github.com/robinkarlberg/transfer.javascript.az-web"
                >
                  Check the code on GitHub &rarr;
                </a>
              </p>
            </div>
            <div className="mt-16">
                ...
                steps={[
                  {
                    step: 1,
                    icon: "hand-index",
                    text: "Pick your files or select a folder",
                  },
                  {
                    step: 2,
                    icon: "hourglass-split",
                    text: "Click 'Zip' and wait",
                  },
                  {
                    step: 3,
