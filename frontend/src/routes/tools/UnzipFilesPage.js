  ...
  return (
    <div>
      <GenericToolPage
        ...
        display={
          <span>
            <span className="text-primary">Easily</span> open your zip file
            online.
          </span>
        }
        subtitle={
          "Decompress and view even the largest zip files with this online tool. We can not read your files, as everything is handled locally in your browser."
        }
      >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-16">
        ...
        {!richFiles && (
          <EmptySpace
            ...
            subtitle={`Your files will be displayed here, allowing you to browse the archive.`}
          />
        )}
          ...
          <>
            <div className="mt-16">
              ...
              <p className="text-lg mb-2">
                Simply upload a zip file from your computer, and it will be
                unpacked instantly, allowing you to view its contents.
              </p>
              <p className="text-lg mb-2">
                You can then choose to download or share individual files for
                free if needed.
              </p>
              <p className="text-lg mb-2">
